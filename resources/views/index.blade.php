    ...
    <div class="container-fluid" style="background-color: rgb(0 0 0 / 70%);">
        ...
        <div class="middle desktop">
            ...
            <div class="middle-center">
                ...
                <p class="text-white mt-5 d-none success-msg">We've sent you an email!<br>Open up your email and click the subscribe button to confirm your email address.</p>
        ...
        <div class="m-middle mobile">
            <div>
                ...
                <p class="text-white mt-4 d-none text-center success-msg">We've sent you an email!<br>Open up your email and click the subscribe button to confirm your email address.</p>
