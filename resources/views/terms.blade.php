    ...
    <div class="container" style="background-color: #121212;">
        ...
        <div class="row" style="padding-top: 120px">
            ...
            <div class="col-12 col-sm-12 col-md-12">
                ...
                <p>Lumiworks Pte. Ltd. (collectively referred to hereinafter as “Lumiworks”, “MillionK”, “we”, “us” or “our”) owns and operates the website www.millionk.com (the “Platform”, “Website”). These Terms of Service sets forth the legally binding terms and conditions for your use of the website. For ease of reference, the website is referred to in these Terms of Service as “MillionK” or “Services”.</p>
                <p>MillionK enables you to purchase personalised videos and other services from a list of available talent (idols, influencers, celebrities & creators – henceforth known as “Talent”)on the website. </p>
                <p>By accessing or using our platform in any manner, including, but not limited to, visiting or browsing our platform or contributing content or other materials to the platform or signing up as a member of our platform or a as a talent on our platform, you agree to be bound by these Terms of Service.<p>
                <p>By accessing or using our platform in any manner, you hereby represent and warrant that you are fully able and competent to enter into the terms, conditions, obligations, affirmations, representations and warranties set forth in these Terms and to abide by and comply with these Terms. We are a global platform and by accessing the Content or Services, you are representing and warranting that, you are of the legal age of maturity in your jurisdiction or of the age required to access such Services and Content.</p>
                <p>We reserve the right, at our sole discretion, to modify or replace these Terms of Service by posting the updated terms on the Website. Your continued use of the Website after any such changes constitutes your acceptance of the new Terms of Service.</p>
                <p>Please review these Terms of Service periodically for changes. If you do not agree to any provision of these Terms of Service or any changes to these Terms of Service, do not use or access or continue to use or access MillionK immediately.</p>
                <p>These Terms applies to all users of the Services, including without limitation users who are contributors of content, information and other materials. If you are entering into this agreement for and on behalf of a business entity, and the term “you” in this agreement shall mean the business entity on whose behalf you are using the Services, unless the context does not permit.
                </p>

                <h5>1. PRIVACY POLICY</h5>
                <p>Please refer to our Privacy Policy for information about how we collect, use and disclose information about our users.</p>

                <h5>2. MILLIONK USER ACCOUNTS</h5>
                <p>By creating an account on our website, you acknowledge and agree to:</p>
                <ul class="text-white">
                    <li>
                    ...
                    <li>
                    Be responsible for all activities that occur on or in connection with your website account, and accept all potential risks of unauthroized access
                ...
                <h5>3. MILLIONK PERSONALISED VIDEOS &  SERVICES</h5>
                <ul class="text-white">
                    <li>
                    ...
                    <li>
                    When posting content through our website to request a video from a Talent, you hereby grant the Talent a perpetual, non-exclusive, fully paid and royalty-free, transferrable, sub-licensable, worldwide license to use the content that you post on or through the website, subject to our Privacy Policy. You represent and warrant that you own or otherwise control all of the rights to the content that you post; that the content is accurate and does not violate any part of this Terms of Service and will not cause injury to any person or entity; and that you will indemnify MillionK for all claims resulting from the content you supply. MillionK has the right but not the obligation to monitor and edit or remove any activity or content. We take no responsibility and assume no liability for any content posted by you or any third party
                    </li>
                    <li>
                ...
                <h5>8. TALENT TERMS OF SERVICE</h5>
                <p>
                ...
                <p>MillionK retains the right at its discretion to suspend or remove a Talent from the Website for any reason whatsoever, which may include violation of this Terms of Service, found to have misrepresented MillionK or any user in the signup process.</p>

                <h5>9. FEES & PAYMENTS</h5>
                <p>Some of the features of the Website, including the request for creation personalised videos by our Talents, other digital services, memberships and subscriptions, and the delivery thereof, will require you to pay a fee. You agree to pay those amounts shown to you during the checkout or similar process.</p>
                <p>
                ...
                <h5>13. TERMINATIONS AND SUSPENSION</h5>
                <p>We may terminate or suspend all or part of the Service and your Service access immediately, without prior notice or liability, if you breach any of the Terms. Upon termination of your access, your right to use the Service will immediately cease.
                ...
                <p>You have the right to opt-out and not be bound by the arbitration and class action waiver provisions set forth above by sending written notice of your decision to opt-out via email at hello@millionk.com with subject line LEGAL OPT OUT. The notice must be sent within 30 days of your first use of the Service, otherwise you shall be bound to arbitrate disputes in accordance with the terms of those paragraphs. If you opt-out of these arbitration provisions, we also will not be bound by them.</p>

                <h5>16. GENERAL INFORMATION</h5>
                ...
                <p>You agree that regardless of any statute or law to the contrary, any claim or cause of action arising out of or related to the use of the Website and/or the Terms must be filed within one (1) year after such claim or cause of action arose or be forever barred.</p>
                <p>The section titles in the Terms are for convenience only and have no legal or contractual effect.</p>

                <h5>17. QUESTIONS AND COMMENTS</h5>
                <p>Users with questions, complaints or claims with respect to the Service may contact us using the relevant contact information set forth above or by email to hello@millionk.com</p>
            </div>
        </div>
    </div>
</div>
