...
@section('content')
<div class="content">
    <div class="container-fluid p-0" style="background-color: #171717;height: unset!important">
        <div class="block-1">  
            <div class="logo">
        ...
        <div class="block-3">
            <div class="text-center block-3-text">
                <h1 class="text-white block-title">REQUEST A STAR ON MILLIONK</h1>
                <div class="horizontal-red-bar"></div>
                <h3 class="text-white block-sub-title">Can't find a celebrity you want to book? Tell us who & we will reach out to sign them up</h3>
                @if(Session::get('success'))
                <h2 class="text-white block-sub-title">{{ Session::get('success') }}</h2>
                @endif
            </div>
            <div class="container mb-5">
                <form class="custom-form" action="{{ route('request-idol-store') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="row m-0">
                        <div class="col-12 col-sm-12 col-md-12 mobile-view">
                            <div class="inputWithIcon">
                                <label class="input-label">Your email address</label>
                                <input type="email" name="email" placeholder="" class="custom-input" required>
                        ...
                        <div class="col-12 col-sm-12 col-md-12 mobile-view">
                            <div class="inputWithIcon">
                                <label class="input-label">Their Name</label>
                                <input type="text" name="their_name" placeholder="" class="custom-input" required>
                                <img class="input-icon" src="{{ asset('assets/images/icons/user.png') }}" style="top: 31px;">
                            </div>
                            @if ($errors->has('their_name'))
                                <span class="help-block pl-3 mb-2 d-block" style="color:#d61919;margin-top: -10px;">
                                    <p class="mb-0">{{ $errors->first('their_name') }}</p>
                                </span>
                            @endif
                        </div>
                        <div class="col-12 col-sm-12 col-md-12 mobile-view">
                            <div class="inputWithIcon">
                                <label class="input-label">Their social media account name</label>
                                <input type="text" name="social_name" placeholder="" class="custom-input" required>
                                <img class="input-icon" src="{{ asset('assets/images/icons/user.png') }}" style="top: 31px;">
                            </div>
                            @if ($errors->has('social_name'))
                                <span class="help-block pl-3 mb-2 d-block" style="color:#d61919;margin-top: -10px;">
                                    <p class="mb-0">{{ $errors->first('social_name') }}</p>
                                </span>
                            @endif
                        </div>
                        <div class="col-12 col-sm-12 col-md-12 mobile-view">
                            <div class="inputWithIcon">
                                <label class="input-label">Leave them a message explaining why you want them on Millionk!</label>
                                <textarea class="custom-textarea" name="question" style="height:80px!important" placeholder="" required></textarea>
                            </div>
                        ...
                        <div class="col-12 mt-3 mobile-view">
    ...
    <div class="footer">
        <div class="container-fluid m-0" style="height: unset!important">
