        ...
        <div class="row desktop" style="padding: 10px 30px;background:#171717;position:relative">
            ...
            <div class="d-flex" style="margin: 10px 0px;right: 35px;position:absolute">
                <div class="footer-social">
                    <a href="https://www.facebook.com/MillionK.official" target="_blank"><img src="{{ asset('assets/images/icons/facebook.png') }}" style="height: 18px"></a>
                </div>
                <div class="footer-social">
                    <a href="https://www.instagram.com/millionk.official" target="_blank"><img src="{{ asset('assets/images/icons/instagram.png') }}" style="height: 18px"></a>
                </div>
                <div class="footer-social">
        ...
        <div class="mobile">
            <div class="row" style="background:#171717">
                ...
                <div class="col-6 d-flex" style="margin: 10px 0px;justify-content: flex-end;">
                    <div class="footer-social">
                        <a href="https://www.facebook.com" target="_blank"><img src="{{ asset('assets/images/icons/facebook.png') }}" style="height: 18px"></a>
                    </div>
                    <div class="footer-social">
                        <a href="https://www.instagram.com" target="_blank"><img src="{{ asset('assets/images/icons/instagram.png') }}" style="height: 18px"></a>
                    </div>
