<div class="footer">
        <div class="container-fluid m-0" style="height: 100%!important;padding: 0 15px;">
            <div class="row desktop" style="padding: 10px 15px;background:#fcfcfc">
                <div class="col-12 d-flex" style="margin: 10px 0px 10px;">
                    <div class="my-auto">
                        <p class="mb-0" style="color:#898989;font-size:15px">Copyright © 2021 Lumiworks.pte.Ltd.All rights reserved.</p>
                    </div>
                </div>
            </div>
            <div class="mobile">
