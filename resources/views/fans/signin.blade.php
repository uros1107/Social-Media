...
@media (min-width: 1024px) and (max-width: 1250px) {
    ...
    .google-btn, .google-btn:hover, .google-btn:focus, .facebook-btn, .facebook-btn:hover, .facebook-btn:focus {
        font-size: 18px;
        padding: 0px;
    }
    .idol-registration .title {
                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-12 mb-3">
                                    <button class="btn custom-btn w-100 google-btn d-flex" type="button">
                                        <div class="ml-5 my-auto">
                                            <!-- <img src="{{ asset('assets/images/icons/google.png') }}" style="width: 20px"> -->
                                ...
                                <div class="col-12">
                                    <button class="btn custom-btn w-100 facebook-btn d-flex" type="button">
                                        <div class="ml-5 my-auto">
                                            <!-- <img src="{{ asset('assets/images/icons/face.png') }}" style="margin-top: -5px;width: 20px"> -->
                                            <i class="fa fa-facebook fa-fw" style="color:#20335f;background: white;padding-top: 3px;"></i>
                                        </div>
                                        <div class="m-auto">
